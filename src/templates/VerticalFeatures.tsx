...
const VerticalFeatures = () => (
  ...
  >
    <VerticalFeatureRow
      ...
      ale Rada guvernérov Európskej centrálnej banky (ECB)². O menovej politike  eurozóny, a teda aj o hodnote euromince, rozhoduje Šesť členov Výkonnej rady a guvernéri národných centrálnych bánk 19 krajín, hlasovaním. 
    ...
    <VerticalFeatureRow
      ...
      description="Nikoho ale neprekvapí, že všetky krajiny hája svoje individuálne záujmy a nehlasujú podľa odporúčaní odborníkov. 
